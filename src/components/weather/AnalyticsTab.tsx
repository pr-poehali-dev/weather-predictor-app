  ...
  return (
    <Card className="p-6 bg-white/95 dark:bg-[#1e2936]/95 backdrop-blur-sm border-0 shadow-xl overflow-hidden">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h3 className="text-lg font-semibold text-[#34495E] dark:text-white">Прогноз от Волк-синоптик AI</h3>
          <p className="text-sm text-[#34495E]/60 dark:text-white/60">Нейросетевой анализ погодных условий</p>
        </div>
      </div>
      <div className="p-4 rounded-xl bg-gradient-to-r from-[#4A90E2]/10 to-[#98D8C8]/10 dark:from-[#4A90E2]/20 dark:to-[#98D8C8]/20">
        <p className="text-[#34495E] dark:text-white leading-relaxed">
